...
客户端仓库：[transcendence-memory](https://example-archive.tk/server/transcendence-memory)
...
| `EMBEDDING_BASE_URL` | Embedding API 地址 | `https://llm.example.com/v1` |
...
| `LLM_BASE_URL` | LLM API 地址 | `https://llm.example.com/v1` |
