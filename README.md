...
mkdir -p tasks/active tasks/archived tasks/rag/containers/host-z memory memory_archive
...
客户端使用与连接请参考 [`transcendence-memory`](https://example-archive.tk/server/transcendence-memory) 仓库。
