...
def test_load_yaml_full_schema(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("EGONEX_API_KEY", "egonex-key")
...
""",
    ...
    assert set(ps.rerankers) == {"egonex-bge"}
