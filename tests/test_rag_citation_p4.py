...
def test_render_fallback_with_placeholders():
    ...
    out = render_fallback_template(
        tpl, {"query": "how to deploy", "container": "example-container", "threshold": 0.35}
    )
    assert out == "No confident answer for 'how to deploy' (container=example-container, threshold=0.35)."
