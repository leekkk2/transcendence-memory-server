...
```json
{
  ...
  "embedding_provider_base_url": "https://llm.example.com/v1",
  ...
  "storage_ready": true,
  "warnings": [],
  "default_container": "host-z",
  "available_containers": ["host-z", "local"],
  "endpoint_defaults": {
    "search.container": "host-z",
    "embed.container": "host-z",
    "build_manifest.container": "host-z",
    "ingest_memory.container": "host-z",
    "ingest_objects.container": "host-z"
  },
  "uptime_seconds": 42,
...
{
  "status": "ok",
  "command": ["/path/to/script.py", "--query", "server-side retrieval", "--topk", "5", "--container", "host-z"],
  "code": 0,
  ...
  "results": [
    {
      "path": "tasks/rag/containers/host-z/manifest.jsonl",
      "score": 0.99,
      "text": "..."
    }
  ],
...
```json
{
  "command": ["/path/to/task_rag_embed.py", "--container", "host-z"],
  "code": 0,
  "stdout": "...",
  "stderr": ""
}
...
```json
{
  "command": ["/path/to/task_rag_build_manifest.py", "--container", "host-z"],
  "code": 0,
  "stdout": "...",
  "stderr": ""
}
...
```json
{
  "command": ["/path/to/task_rag_ingest_memory_refs.py", "--container", "host-z"],
  "code": 0,
  "stdout": "...",
  "stderr": ""
}
...
```json
{
  "container": "host-z",
  "accepted": 2,
  "stored_path": "/workspace/tasks/rag/containers/host-z/client-ingest-1711765800000000000-0001-note-001.jsonl",
  "stored_paths": [
    "/workspace/tasks/rag/containers/host-z/client-ingest-1711765800000000000-0001-note-001.jsonl",
    "/workspace/tasks/rag/containers/host-z/client-ingest-1711765800000000000-0002-note-002.jsonl"
  ],
